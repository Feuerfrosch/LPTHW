...
class Scene(object):
    ...
    def enter(self):
        print "Thise scene is not yet configured. Subclass it and implement enter()."
        exit(1)

class Engine(object):

    def __init__(self, scnee_map):
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "off your aim. Your laser hits his costume but misses him entirely. The laser"

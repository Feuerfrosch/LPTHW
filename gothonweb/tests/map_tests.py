...
def test_room():
    gold = Scene("GoldScene", "goldroom",
                """This Scene has gold in it you can grab. There's a
                door to the north.""")
...
def test_gothon_game_map():
    ...
    assert_equal(laser_weapon_armory.go(map.counter), the_bridge)
    assert_equal(laser_weapon_armory.go('I give up'), code_death)
